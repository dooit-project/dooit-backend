...
import pj.dooit.config.QuerydslConfig;
import pj.dooit.support.RepositoryTestSupport;
...
class RecurrenceOccurrenceMaterializerTest extends RepositoryTestSupport {
    ...
    void materializeForWorkspace_createsWorkspaceOccurrences() {
        ...
        assertThat(tasks.get(1).getScope()).isEqualTo(pj.dooit.common.domain.ResourceScope.WORKSPACE);
