...
class OpenApiDocumentationIntegrationTest {
    ...
    void documentationUi_v1ApiDocsAndTagOrder() throws Exception {
        mockMvc.perform(get("/v3/api-docs"))
                ...
                .andExpect(jsonPath("$.tags[4].name").value("v1 Task Template"))
                .andExpect(jsonPath("$.tags[5].name").value("v1 System"))
                .andExpect(jsonPath("$.tags[6].name").value("v1 Workspace"))
                .andExpect(jsonPath("$.tags[7].name").value("v1 Auth"))
