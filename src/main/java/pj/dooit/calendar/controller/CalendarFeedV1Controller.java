    ...
    public ResponseEntity<String> feed(@PathVariable String token) {
        return calendarFeedService.renderFeed(token)
                .map(body -> ResponseEntity.ok()
                        ...
                        .header(HttpHeaders.CONTENT_DISPOSITION, "inline; filename=\"dooit.ics\"")
                        .body(body))
