...
import pj.dooit.task.domain.query.DateRange;
import pj.dooit.task.domain.query.TaskQueryType;
import pj.dooit.task.domain.query.TaskSearchDateField;
...
import pj.dooit.task.dto.TaskRecommendationResponse;
import pj.dooit.task.dto.TaskRecurrenceRequest;
import pj.dooit.task.dto.TaskResponse;
import pj.dooit.task.dto.TaskSearchItemResponse;
import pj.dooit.task.dto.TaskSearchRequest;
import pj.dooit.task.dto.TaskSearchResponse;
...
public class TaskService {
    ...
    public List<TaskNotificationCandidateResponse> getNotificationCandidatesForOwner(
        ...
        return taskRepository.findNotificationCandidateTasks(ownerId, serviceRange.getStart(), serviceRange.getEnd()).stream()
                ...
                .filter(task -> task.getRecurrenceException() != pj.dooit.task.domain.RecurrenceExceptionType.SKIPPED)
