...
| --- | --- | --- | --- | --- | --- |
| `10001` | 400 | `값이 올바르지 않습니다.` | validation 실패, enum/date/type mismatch, JSON 파싱 실패, 마지막 ACTIVE OWNER 강등/제거/탈퇴 시도 | 입력값 확인 후 재요청 | 아니오 |
...
| `20003` | 404 | `Task 템플릿을 찾을 수 없습니다.` | Task template 없음 또는 owner scope 밖 | 템플릿 목록 재조회 | 아니오 |
...
| `50002` | 404 | `공유 workspace 멤버를 찾을 수 없습니다.` | workspace member 없음 또는 workspace scope 밖 | 멤버 목록 재조회 | 아니오 |
